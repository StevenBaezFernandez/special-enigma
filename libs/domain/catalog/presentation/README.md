# catalog-presentation (Presentation Layer)

## 🎯 Purpose
This library serves as the **Entry Point** for the **Catalog** domain. It handles HTTP requests, GraphQL queries, and event subscriptions, delegating execution to the Application layer.
