# inventory-application (Application Layer)

## 🎯 Purpose
This library implements the **Use Cases** and orchestrates the flow of data for the **Inventory** domain. It acts as the glue between the Presentation layer and the Domain layer.
