# accounting-domain (Domain Layer)

## 🎯 Purpose
This library encapsulates the **Pure Business Logic** and **Enterprise Rules** for the **Accounting** domain. It is the heart of the system, designed to be framework-agnostic and free of external dependencies.
