...
check_pattern "MockFiscalProvider" "apps libs -g !**/*.spec.ts -g !**/*.test.ts -g !libs/domains/fiscal/infrastructure/src/lib/adapters/mock-fiscal-provider.adapter.ts" "Detected mock fiscal provider reference in runtime source"
